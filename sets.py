...
lister = ['a','c','b','m','d','b','d']
setter = set(lister)
repeating =[]
for letter in setter:
  occurance = lister.count(letter)
  if occurance > 1: repeating.append(letter)
print(repeating)

rep = []

for letter in lister:
  count = lister.count(letter)
  if count>1 and letter not in rep:
    rep.append(letter)
print(rep)